...
//<<<<<<< HEAD
    ...
    public static final float GENERICSPEEDMULT = 1;
    public static final float GENERICRANGEMULT = 2;
    public static final float NERDYRANGEMULT = 1;
    public static final float SPORTYRANGEMULT = 1;
}
